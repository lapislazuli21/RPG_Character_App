...
final List<Skill> allSkills = [
  ...
  Skill(id: '9', name: 'Infinite Loop', image: 'i_loop.jpg', vocation: Vocation.tank),
  Skill(id: '10', name: 'Type Cast', image: 't_cast.jpg', vocation: Vocation.tank),
  Skill(id: '11', name: 'Encapsulate', image: 'encapsulate.jpg', vocation: Vocation.tank),
  Skill(id: '12', name: 'Copy & Paste', image: 'c_paste.jpg', vocation: Vocation.tank),
